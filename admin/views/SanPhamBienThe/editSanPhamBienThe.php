...
<div class="col-md-12"> <!--begin::Quick Example-->
    <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
        <div class="card-header">
            ...
            <?php if (isset($_SESSION['alert_success'])): ?>
                <div class="alert alert-success w-100" role="alert">
                    Sửa thành công. <a href="<?= BASE_URL_ADMIN . "/?act=form-sua-san-pham&id_san_pham=".$_SESSION['san_pham']['id_san_pham'] ?>" class="alert-link">Đi đến trang sửa sản phẩm .</a>
                </div>
        ...
        <form enctype="multipart/form-data" method="POST"  action="<?= BASE_URL_ADMIN . '/?act=sua-san-pham-bien-the' ?>" >
            <div class="card-body">
                <div class="row">
                  <input type="text" name="id_san_pham" value="<?= $_SESSION['san_pham']['id_san_pham'] ?? '' ?>" hidden >
                  <input type="text" name="id" value="<?= $_SESSION['san_pham']['id'] ?? '' ?>" hidden >
                  <input type="text" name="hinh_anh_old" value="<?= $_SESSION['san_pham']['hinh_anh'] ?? '' ?>" hidden >
                    ...
                    <div class="mb-3 col-md-4 "> 
                        <img src="<?= BASE_URL . $_SESSION['san_pham']['hinh_anh'] ?>"  height="100px" alt="">
                    </div>
...
<div><a href="<?= BASE_URL_ADMIN . "/?act=form-sua-san-pham&id_san_pham=".$_SESSION['san_pham']['id_san_pham'] ?>"><button class="btn btn-success">Quay lại</button></a></div>
