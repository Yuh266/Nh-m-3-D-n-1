...
<div class="col-md-12"> <!--begin::Quick Example-->
    <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
        ...
        <form method="POST" action="<?= BASE_URL_ADMIN . "/?act=sua-".$title_url ?>"  > <!--begin::Body-->
            <div class="card-body">
                <input type="text" name="id" value="<?= $_SESSION['trang_thai']['id']??"" ?>" hidden >
                <div class="row">
                    <div class="mb-3 col-md-12"> 
                        <label for="exampleInputEmail1" class="form-label">Tên trạng thái</label> 
                        <input value="<?= $_SESSION['trang_thai']['ten_trang_thai']??"" ?>" name="ten_trang_thai" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        <div id="emailHelp" class="form-text text-danger">
                            <?= $_SESSION['error']['ten_trang_thai']??"" ?>
                        </div>
                    </div>
                </div>
