...
<head>
    ...
    <title>Login | Plant Haven</title><!--begin::Primary Meta Tags-->
    ...
    <link rel="stylesheet" href="<?= BASE_URL_ADMIN . "/assets" ?>/dist/css/adminlte.css"><!--end::Required Plugin(AdminLTE)-->
    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body login-card-body">
                ...
                <form action="<?= BASE_URL_ADMIN."/?act=dang-nhap" ?>" method="post">
                    <div class="input-group mb-1">
                        <div class="form-floating"> <input id="loginEmail" type="email" class="form-control" name="email" placeholder=""> <label for="loginEmail">Email</label> </div>
                        <div class="input-group-text"> <span class="bi bi-envelope"></span> </div>
                    </div>
                    <div class="form-text text-danger"><?= $_SESSION['error']['email'] ?? "" ?></div>
                    <div class="input-group mb-1">
                        <div class="form-floating"> <input id="loginPassword" type="password" name="mat_khau" class="form-control" placeholder=""> <label for="loginPassword">Mật khẩu</label> </div>
